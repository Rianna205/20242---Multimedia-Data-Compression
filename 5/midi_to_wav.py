...
sound_font_path = "E:/Study_bk/nen/MIDI Jazz/FluidR3_GM/FluidR3_GM.sf2"  # Replace with the path to your .sf2 soundfont file
input_midi_path = "E:/Study_bk/nen/final.mid"     # Replace with the path to your input MIDI file
output_wav_path = "E:/Study_bk/nen/output.wav"    # Replace with the desired path for the output WAV file
